...
export default function BulkEditEmployeeModal({
  ...
  const mapEmployeeToSelected = (employeeData: any) => ({
    ...
    status: employeeData.status || "DANG_CONG_TAC",
    ...
    subDepartmentId: employeeData.subDepartmentId?.toString() || "",
    ...
    foreignLanguageId: employeeData.foreignLanguageId?.toString() || "", // đổi từ languageId
    ...
    occupationId: employeeData.occupationId?.toString() || "", // đổi từ specialtyId
    ...
    // Lương
    payrollId: employeeData.payrollId?.toString() || "", // đổi từ salaryPayrollId
    payrollName: employeeData.payrollName || "",
    salaryScaleId: employeeData.salaryScaleId?.toString() || "",
    salaryScaleName: employeeData.salaryScaleName || "",
    salaryCoefficient: employeeData.salaryCoefficient || "",
    salaryAmount: employeeData.salaryAmount || "",
    effectiveDate: employeeData.effectiveDate || "", // đổi từ salaryEffectiveDate

    // BHXH
    insurancePayrollId: employeeData.insurancePayrollId?.toString() || "", // đổi từ socialInsurancePayrollId
    insuranceSalaryScaleId:
      employeeData.insuranceSalaryScaleId?.toString() || "", // đổi từ socialInsuranceSalaryScaleId
    insuranceSalaryCoefficient: employeeData.insuranceSalaryCoefficient || "", // đổi từ socialInsuranceSalaryCoefficient
    insuranceSalaryBase: employeeData.insuranceSalaryBase || "", // đổi từ socialInsuranceSalaryAmount
    insurancePlace: employeeData.insurancePlace || "", // đổi từ socialInsurancePlace
    insuranceBookNumber: employeeData.insuranceBookNumber || "",
    socialInsuranceNumber: employeeData.socialInsuranceNumber || "",
    socialInsuranceStartDate: employeeData.socialInsuranceStartDate || "",
    insuranceUnionSalary: employeeData.insuranceUnionSalary || "", // đổi từ unionSalary
    insurancePositionId: employeeData.insurancePositionId?.toString() || "", // đổi từ socialInsuranceJobTitleId
    ...
    decreaseReasonId: employeeData.decreaseReasonId?.toString() || "",
    increaseReasonId: employeeData.increaseReasonId?.toString() || "",

    // Ghi chú
    note: employeeData.note || "",

    // Quá trình công tác
    workProcesses: employeeData.workProcesses || [],
  ...
  const handleAddEmployee = async (employeeId: number) => {
    ...
    try {
      ...
      setSelectedEmployees((prev) => [
        ...prev,
        mapEmployeeToSelected(employeeData),
      ]);
  ...
  const handleExportExcel = async () => {
    try {
      ...
      saveAs(
        blob,
        `Chinh_sua_nhan_vien_${new Date().toISOString().split("T")[0]}.xlsx`,
      );
  ...
  const handleImportExcel = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const existingCodes = new Map(
        selectedEmployees.map((emp) => [emp.code, emp]),
      );
  ...
  const handleSubmit = () => {
    ...
    const payload = selectedEmployees.map((emp) => ({
      ...
      // Định danh
      companyId: emp.companyId ? Number(emp.companyId) : null,
      subDepartmentId: emp.subDepartmentId ? Number(emp.subDepartmentId) : null,
      departmentId: emp.departmentId ? Number(emp.departmentId) : null,
      positionId: emp.positionId ? Number(emp.positionId) : null,
      subPositionId: emp.subPositionId ? Number(emp.subPositionId) : null,
      jobTitleId: emp.jobTitleId ? Number(emp.jobTitleId) : null,
      jobPositionId: emp.jobPositionId ? Number(emp.jobPositionId) : null,
      taxCode: emp.taxCode || null,
      partyCommitteeId: emp.partyCommitteeId
        ? Number(emp.partyCommitteeId)
        : null,
      subPartyCommitteeId: emp.subPartyCommitteeId
        ? Number(emp.subPartyCommitteeId)
        : null,

      // Tuyển dụng
      laborContractTypeId: emp.laborContractTypeId
        ? Number(emp.laborContractTypeId)
        : null,
      contractType: emp.contractType || null,
      salary: emp.salary || null,
      previousJob: emp.previousJob || null,
      recruitmentDate: emp.recruitmentDate || null,
      organizationId: emp.organizationId ? Number(emp.organizationId) : null,
      ...
      wardId: emp.wardId ? Number(emp.wardId) : null,
      provinceCityId: emp.provinceCityId ? Number(emp.provinceCityId) : null,

      // Thông tin cá nhân
      ethnicity: emp.ethnicity || null,
      religion: emp.religion || null,
      nationalityId: emp.nationalityId ? Number(emp.nationalityId) : null,
      policyFamilyId: emp.policyFamilyId ? Number(emp.policyFamilyId) : null,
      ...
      educationLevelId: emp.educationLevelId
        ? Number(emp.educationLevelId)
        : null,
      politicalTheoryId: emp.politicalTheoryId
        ? Number(emp.politicalTheoryId)
        : null,
      foreignLanguageId: emp.foreignLanguageId
        ? Number(emp.foreignLanguageId)
        : null,
      languageLevelId: emp.languageLevelId ? Number(emp.languageLevelId) : null,
      culturalLevelId: emp.culturalLevelId ? Number(emp.culturalLevelId) : null,
      professionalLevelId: emp.professionalLevelId
        ? Number(emp.professionalLevelId)
        : null,
      itLevelId: emp.itLevelId ? Number(emp.itLevelId) : null,
      trainingMajorId: emp.trainingMajorId ? Number(emp.trainingMajorId) : null,
      occupationId: emp.occupationId ? Number(emp.occupationId) : null,

      // Quân sự & Đảng
      militaryJoinDate: emp.militaryJoinDate || null,
      militaryEndDate: emp.militaryEndDate || null,
      militaryRankId: emp.militaryRankId ? Number(emp.militaryRankId) : null,
      ...
      // Lương
      payrollId: emp.payrollId ? Number(emp.payrollId) : null,
      payrollName: emp.payrollName || null,
      salaryScaleId: emp.salaryScaleId ? Number(emp.salaryScaleId) : null,
      ...
      // BHXH
      insurancePayrollId: emp.insurancePayrollId
        ? Number(emp.insurancePayrollId)
        : null,
      insuranceSalaryScaleId: emp.insuranceSalaryScaleId
        ? Number(emp.insuranceSalaryScaleId)
        : null,
      insuranceSalaryCoefficient: emp.insuranceSalaryCoefficient || null,
      insuranceSalaryBase: emp.insuranceSalaryBase || null,
      insurancePlace: emp.insurancePlace || null,
      ...
      insuranceUnionSalary: emp.insuranceUnionSalary || null,
      insurancePositionId: emp.insurancePositionId
        ? Number(emp.insurancePositionId)
        : null,
      socialInsuranceJobId: emp.socialInsuranceJobId
        ? Number(emp.socialInsuranceJobId)
        : null,
      ...
      decreaseReasonId: emp.decreaseReasonId
        ? Number(emp.decreaseReasonId)
        : null,
      increaseReasonId: emp.increaseReasonId
        ? Number(emp.increaseReasonId)
        : null,
      ...
      case "relativesAbroad":
        return (
          <Input
            ...
            onChange={(e) =>
              handleFieldChange(employee.id, field, e.target.value)
            }
      ...
      case "gender":
        return (
          <Select
            ...
            onValueChange={(value) =>
              handleFieldChange(employee.id, "gender", value)
            }
          >
          ...
          <div className="flex items-center justify-center">
            <Checkbox
              ...
              onCheckedChange={(checked) =>
                handleFieldChange(employee.id, "isWoundedSoldier", checked)
              }
            />
          </div>
        );
      ...
      case "note":
        return (
          <Textarea
            value={employee.note}
            onChange={(e) =>
              handleFieldChange(employee.id, "note", e.target.value)
            }
          ...
          <div className="grid grid-cols-4 gap-3">
            <div className="space-y-1">
              ...
              <GenericSearchSelect
                ...
                onChange={(v) =>
                  handleFieldChange(employee.id, "companyId", String(v))
                }
              />
            </div>
            <div className="space-y-1">
            ...
            <div className="space-y-1">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleFieldChange(employee.id, "fullName", e.target.value)
                }
                className="h-8 text-sm"
            ...
            <div className="space-y-1">
              ...
              <Select
                value={employee.gender}
                onValueChange={(v) =>
                  handleFieldChange(employee.id, "gender", v)
                }
              >
            ...
            <div className="space-y-1">
              <Field label="Nơi sinh (Tỉnh/Thành Phố)" required>
                <NameSelectField
                  ...
                  onChange={(v) =>
                    handleFieldChange(employee.id, "birthPlace", v)
                  }
                />
              </Field>
            </div>
            ...
            <div className="space-y-1">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleFieldChange(employee.id, "phone", e.target.value)
                }
                className="h-8 text-sm"
          ...
          <div className="grid grid-cols-4 gap-3">
            <div className="space-y-1">
              ...
              <GenericSearchSelect
                ...
                onChange={(v) =>
                  handleFieldChange(employee.id, "positionId", String(v))
                }
              />
            </div>
            <div className="space-y-1">
            ...
            <div className="space-y-1">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleFieldChange(employee.id, "taxCode", e.target.value)
                }
                className="h-8 text-sm"
                placeholder="Nhập mã"
              />
            ...
            <div className="space-y-1">
              ...
              <GenericSearchSelect
                ...
                onChange={(v) =>
                  handleFieldChange(employee.id, "subPositionId", String(v))
                }
              />
            </div>
            <div className="space-y-1">
              ...
              <GenericSearchSelect
                ...
                onChange={(v) =>
                  handleFieldChange(employee.id, "jobTitleId", String(v))
                }
              />
            </div>
            <div className="space-y-1">
              ...
              <GenericSearchSelect
                ...
                onChange={(v) =>
                  handleFieldChange(employee.id, "jobPositionId", String(v))
                }
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-4 gap-3">
            <div className="space-y-1">
              ...
              <GenericSearchSelect
                ...
                onChange={(v) =>
                  handleFieldChange(employee.id, "ethnicity", String(v))
                }
              />
            </div>
            <div className="space-y-1">
              ...
              <GenericSearchSelect
                ...
                onChange={(v) =>
                  handleFieldChange(employee.id, "religionId", String(v))
                }
              />
            </div>
            <div className="space-y-1">
              ...
              <GenericSearchSelect
                ...
                onChange={(v) =>
                  handleFieldChange(employee.id, "nationalityId", String(v))
                }
              />
            </div>
            <div className="space-y-1">
        ...
        <div className="grid grid-cols-4 gap-3">
          ...
          <div className="space-y-1">
            ...
            <Input
              ...
              onChange={(e) =>
                handleFieldChange(employee.id, "title", e.target.value)
              }
              className="h-8 text-sm"
          ...
          <div className="space-y-1">
            ...
            <GenericSearchSelect
              ...
              onChange={(v) =>
                handleFieldChange(employee.id, "militaryRankId", String(v))
              }
            />
          </div>
          <div className="space-y-1">
            ...
            <Input
              ...
              onChange={(e) =>
                handleFieldChange(employee.id, "injuryRank", e.target.value)
              }
              className="h-8 text-sm"
        ...
        <div className="grid grid-cols-4 gap-3">
          <div className="space-y-1">
            ...
            <Input
              ...
              onChange={(e) =>
                handleFieldChange(employee.id, "cccdNumber", e.target.value)
              }
              className="h-8 text-sm"
          ...
          <div className="space-y-1">
            ...
            <Input
              ...
              onChange={(e) =>
                handleFieldChange(employee.id, "cccdDate", e.target.value)
              }
              className="h-8 text-sm"
            />
          </div>
          <div className="space-y-1">
            ...
            <Input
              ...
              onChange={(e) =>
                handleFieldChange(employee.id, "cccdPlace", e.target.value)
              }
              className="h-8 text-sm"
          ...
          <div className="space-y-1">
            ...
            <Input
              ...
              onChange={(e) =>
                handleFieldChange(employee.id, "cardNumber", e.target.value)
              }
              className="h-8 text-sm"
        ...
        <div className="grid grid-cols-4 gap-3">
          ...
          <div className="space-y-1">
            ...
            <Input
              ...
              onChange={(e) =>
                handleFieldChange(employee.id, "usableArea", e.target.value)
              }
              className="h-8 text-sm"
              placeholder="m²"
            />
          ...
          <div className="space-y-1">
            ...
            <Input
              ...
              onChange={(e) =>
                handleFieldChange(employee.id, "otherLand", e.target.value)
              }
              className="h-8 text-sm"
              placeholder="Mô tả"
            />
        ...
        <div className="grid grid-cols-4 gap-3">
          ...
          <div className="space-y-1">
            ...
            <Input
              ...
              onChange={(e) =>
                handleFieldChange(employee.id, "bankName", e.target.value)
              }
              className="h-8 text-sm"
          ...
          <div className="space-y-1">
            ...
            <Input
              ...
              onChange={(e) =>
                handleFieldChange(employee.id, "bankBranch", e.target.value)
              }
              className="h-8 text-sm"
        ...
        <div className="grid grid-cols-4 gap-3">
          <div className="space-y-1">
            ...
            <Input
              ...
              onChange={(e) =>
                handleFieldChange(employee.id, "startDate", e.target.value)
              }
              className="h-8 text-sm"
            />
          </div>
          ...
          <div className="space-y-1">
            ...
            <GenericSearchSelect
              ...
              onChange={(v) =>
                handleFieldChange(employee.id, "organizationId", String(v))
              }
            />
          </div>
          <div className="space-y-1">
          ...
          <div className="space-y-1">
            ...
            <Input
              ...
              onChange={(e) =>
                handleFieldChange(employee.id, "longestJob", e.target.value)
              }
              className="h-8 text-sm"
        ...
        <div className="grid grid-cols-4 gap-3">
          ...
          <div className="space-y-1">
            ...
            <GenericSearchSelect
              ...
              onChange={(v) =>
                handleFieldChange(employee.id, "culturalLevelId", String(v))
              }
            />
          </div>
          <div className="space-y-1">
          ...
          <div className="space-y-1">
            ...
            <GenericSearchSelect
              ...
              onChange={(v) =>
                handleFieldChange(employee.id, "occupationId", String(v))
              }
            />
          </div>
          <div className="space-y-1">
            ...
            <GenericSearchSelect
              ...
              onChange={(v) =>
                handleFieldChange(employee.id, "itLevelId", String(v))
              }
            />
          </div>
          <div className="space-y-1">
          ...
          <div className="space-y-1">
            ...
            <GenericSearchSelect
              ...
              onChange={(v) =>
                handleFieldChange(employee.id, "languageLevelId", String(v))
              }
            />
          </div>
          <div className="space-y-1">
          ...
          <div className="space-y-1">
            ...
            <GenericSearchSelect
              ...
              onChange={(v) =>
                handleFieldChange(employee.id, "trainingMajorId", String(v))
              }
            />
          </div>
          <div className="space-y-1">
            ...
            <GenericSearchSelect
              ...
              onChange={(v) =>
                handleFieldChange(employee.id, "trainingTypeId", String(v))
              }
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-4 gap-3">
          <div className="space-y-1">
            ...
            <GenericSearchSelect
              ...
              onChange={(v) =>
                handleFieldChange(employee.id, "payrollId", String(v))
              }
            />
          </div>
          <div className="space-y-1">
            ...
            <GenericSearchSelect
              ...
              onChange={(v) =>
                handleFieldChange(employee.id, "salaryScaleId", String(v))
              }
            />
          </div>
          <div className="space-y-1">
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-[95vw] w-full h-[90vh] flex flex-col overflow-hidden">
        <DialogHeader>
          ...
          <DialogDescription>
            Tìm kiếm và chọn nhân viên để chỉnh sửa thông tin. Các trường được
        ...
        <DialogFooter className="border-t pt-4">
          ...
          <Button
            ...
            disabled={
              updateMutation.isPending || selectedEmployees.length === 0
            }
          ...
          >
            ...
            {updateMutation.isPending
              ? "Đang lưu..."
              : `Xác nhận (${selectedEmployees.length})`}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
