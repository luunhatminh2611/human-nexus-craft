...
import { Search, Eye, ChevronLeft, ChevronRight, FileText, Plus, Edit, Plane } from 'lucide-react';
...
import OverseasApprovalModal from '../components/OverseasApprovalModal';
...
export default function OverseasHRPage() {
  ...
  useEffect(() => {
    fetchTrips();
  }, [page, pageSize, searchTerm, statusFilter, departmentFilter, fundingFilter, refreshKey]);
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Phê duyệt và quản lý thông tin xuất cảnh của tất cả nhân viên
          </p>
        </div>
      ...
      <Card className="p-4">
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1 relative">
            ...
            <Input
              placeholder="Tìm kiếm theo tên nhân viên, quốc gia, mục đích hoặc số quyết định"
              value={searchTerm}
                  ...
                  <TableRow key={trip.id}>
                    <TableCell>
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">{trip.departmentName}</p>
                      </div>
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell>
                      <div className="flex gap-1 justify-center">
                        ...
                        <Button
                          variant="ghost"
                          size="sm"
                          onClick={() => handleOpenApprovalModal(trip.id)}
