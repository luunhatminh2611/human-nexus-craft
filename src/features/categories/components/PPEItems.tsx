...
export default function PPEItemsTab() {
  ...
  const totalPages = Math.ceil(filteredPPEItems.length / itemsPerPage);

  const paginatedPPEItems = useMemo(() => {
    const startIndex = (currentPage - 1) * itemsPerPage;
    return filteredPPEItems.slice(startIndex, startIndex + itemsPerPage);
  }, [filteredPPEItems, currentPage, itemsPerPage]);
    ...
    <div className="space-y-4 p-4">
      <div className="grid grid-cols-6 items-center gap-4">
        <div className="flex col-span-6 items-center gap-2">
          ...
          <div className="relative flex-1">
            ...
            <Input
              placeholder="Tìm kiếm theo tên, mô tả, kích cỡ..."
              value={searchTerm}
        ...
        <Table>
          <TableHeader className='bg-muted'>
            <TableRow>
              ...
              <TableHead className="border">Kích cỡ</TableHead>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            <DialogTitle>
              {selectedItem ? 'Cập nhật đồ bảo hộ lao động' : 'Thêm đồ bảo hộ lao động mới'}
            </DialogTitle>
          </DialogHeader>
